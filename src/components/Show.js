      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <Link to={`/edit/${this.state.book._id}`} class="btn btn-success">Düzenle</Link>&nbsp;
            <button onClick={this.delete.bind(this, this.state.book._id)} class="btn btn-danger">Sil</button>
          </div>
        </div>
      </div>
    );
